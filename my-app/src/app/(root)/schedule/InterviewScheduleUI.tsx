            ...
            <div className="space-y-4 py-4">
              ...
              <div className="flex gap-4">
                <div className="space-y-7 space-x-3">
                  ...
                  <Calendar mode="single" selected={formData.date} onSelect={(date) => date && setFormData({ ...formData, date })} disabled={(date) => date < new Date()} className="rounded-md border" />
                </div>
                <div className="space-y-2">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button onClick={scheduleMeeting} disabled={isCreating}>
                  {isCreating ? (
                    <>
                      <Loader2Icon className="mr-2 size-4 animate-spin" /> Scheduling...
                    </>
                  ) : (
                    "Schedule Interview"
                  )}
